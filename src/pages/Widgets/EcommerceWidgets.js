...
const EcommerceWidgets = () => {
  ...
  const confirnPayment = () => {
    if (document.querySelector("input[name=listGroupRadioGrid]:checked")) {
      ...
      document.querySelector("#notification-overlay .success-pay").innerHTML =
        payamount;
    } else {
          ...
          <Card className="card-height-100">
            <CardBody>
              ...
              <p className="text-muted pb-1">
                If you couldn't relate to the information in the previous point,
                you might be looking for the singlet T-shirt, which is also
                known as the half T-shirt.
              </p>
              ...
              <Link to="#" className="btn btn-soft-secondary d-block">
                Add to Cart
              </Link>
            </CardBody>
          </Card>
              ...
              <div className="col-lg-6">
                <div className="card-body text-center">
                  ...
                  <div>
                    <button
                      type="button"
                      className="btn btn-danger rounded-pill w-sm"
                    >
