...
import { TreeSelect, DatePicker, Select, Popconfirm, Steps } from "antd";
...
const UpdateVideoArticle = ({ article_type, detailData, setReload }) => {
  ...
  document.title = "Sửa bài viết | Toà Soạn Hội Tụ";
  ...
  return (
    <div className="page-content">
      ...
      <Row>
        <div className="row">
          <div className="col-8" style={{ overflow: "auto", height: "80vh" }}>
            <Col lg={12}>
              <Card>
                <CardBody>
                  <Form
          ...
          <div className="col-4" style={{ overflow: "auto", height: "80vh" }}>
            <Col lg={12}>
              <Card>
                <CardHeader>
                  <Nav
...
export default UpdateVideoArticle;
